            ...
            <div class="container container-fluid mt-5">
                ...
                <form class="user" method="post" action="/register/create">
                    ...
                    <div class="form-floating mt-5 mb-3">
                        <input type="text" class="form-control @error('NAME') is-invalid @enderror" style="background-color: #dddddd; text-decoration: none;" id="floatingInput" placeholder="name@example.com" name="NAMA_USER" value="{{ old('NAME') }}">
